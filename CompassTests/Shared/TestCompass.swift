...
class TestCompass: XCTestCase {
  ...
  func testParseArguments() {
    let expectation = self.expectation(description: "Parse arguments")
  ...
  func testParseFragments() {
    ...
    Compass.parse(url, fragments: ["meta" : "foo" as AnyObject]) { route, arguments, fragments in
      XCTAssertEqual("profile:{user}", route)
      XCTAssertEqual(arguments["user"], "testUser")
  ...
  func testParseRouteConcreateMatchCount() {
    let expectation = self.expectation(description: "Parse route having concrete match count")
  ...
  func testParseRouteWildcardMatchCount() {
    let expectation = self.expectation(description: "Parse route having wildcard match count")
  ...
  func testParseRouteSamePrefix() {
    let expectation = self.expectation(description: "Parse route having same prefix")
  ...
  func testParseMultipleArguments() {
    let expectation = self.expectation(description: "Parse multiple arguments")
  ...
  func testParseMultipleArgumentsWithFirstWildcard() {
    let expectation = self.expectation(description: "Parse multiple arguments with first wild card")
  ...
  func testParseWithoutArguments() {
    let expectation = self.expectation(description: "Parse without arguments")
  ...
  func testParseRegularURLWithFragments() {
    let expectation = self.expectation(description: "Parse URL with fragments")
  ...
  func testParseRegularURLWithFragmentsAndGoogleOAuth2AccessToken() {
    let expectation = self.expectation(description: "Parse URL with fragments and Google OAuth 2.0 access token format")
  ...
  func testParseRegularURLWithFragmentsAndAlternativeAccessToken() {
    let expectation = self.expectation(description: "Parse URL with fragments and alternative access token format")
    let url = URL(string: "compassTests://callback/#access_token=ya29.Ci8nA1pNVMFffHkS5-sXooNGvTB9q8QPtoM56sWpipRyjhwwEiKyZxvRQTR8saqWzQ=&token_type=Bearer&expires_in=3600")!
  ...
  func testParseRegularURLWithSlashQuery() {
    let expectation = self.expectation(description: "Parse URL with slash query")
  ...
  func testParseRegularURLWithSlashQueryAndGoogleOAuth2AccessToken() {
    let expectation = self.expectation(description: "Parse URL with slash query and Google OAuth 2.0 access token format")
    let url = URL(string: "compassTests://callback/?access_token=ya29.Ci8nA1pNVMFffHkS5-sXooNGvTB9q8QPtoM56sWpipRyjhwwEiKyZxvRQTR8saqWzQ&token_type=Bearer&expires_in=3600")!
  ...
  func testParseRegularURLWithSlashQueryAndAlternativeAccessToken() {
    let expectation = self.expectation(description: "Parse URL with slash query and alternative access token format")
    let url = URL(string: "compassTests://callback/?access_token=ya29.Ci8nA1pNVMFffHkS5-sXooNGvTB9q8QPtoM56sWpipRyjhwwEiKyZxvRQTR8saqWzQ=&token_type=Bearer&expires_in=3600")!
  ...
  func testParseRegularURLWithQuery() {
    let expectation = self.expectation(description: "Parse URL with query")
    let url = URL(string: "compassTests://callback?access_token=Yo0OMrVZbRWNmgA6BT99hyuTUTNRGvqEEAQyeN1eslclzhFD0M8AidB4Z7Vs2NU8WoSNW0vYb961O38l&token_type=Bearer&expires_in=3600")!
  ...
  func testParseRegularURLWithQueryAndGoogleOAuth2AccessToken() {
    let expectation = self.expectation(description: "Parse URL with query and Google OAuth 2.0 access token format")
    let url = URL(string: "compassTests://callback?access_token=ya29.Ci8nA1pNVMFffHkS5-sXooNGvTB9q8QPtoM56sWpipRyjhwwEiKyZxvRQTR8saqWzQ&token_type=Bearer&expires_in=3600")!
  ...
  func testParseRegularURLWithQueryAndAlternativeAccessToken() {
    let expectation = self.expectation(description: "Parse URL with query and alternative access token format")
    let url = URL(string: "compassTests://callback?access_token=ya29.Ci8nA1pNVMFffHkS5-sXooNGvTB9q8QPtoM56sWpipRyjhwwEiKyZxvRQTR8saqWzQ=&token_type=Bearer&expires_in=3600")!
